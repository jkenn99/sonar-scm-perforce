...
public class PerforceBlameCommand extends BlameCommand {
  ...
  private final Map<Integer, IFileRevisionData> revisionDataByChangelistId = new ConcurrentHashMap<Integer, IFileRevisionData>();
  private final Map<Integer, IChangelist> changelistCache = new ConcurrentHashMap<Integer, IChangelist>();
